	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity instanceof Player _player && !_player.level().isClientSide())
			_player.displayClientMessage(
					Component.literal(
							("About LlamaBlocks -- version " + "1.2.0" + " made for Minecraft 1.21.8 w/ Neoforge " + "-- LlamaMod is developed by Omegabird113 w/ MCreator version " + "2025.3, plus the Blockstates and Configuration Files plugins.")),
					false);
		{
			Entity _ent = entity;
