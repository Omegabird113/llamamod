package mc.omegabird.llamablocks.configuration;
...
public class LlamamodserverconfigConfiguration {
	...
	public static final ModConfigSpec.ConfigValue<Double> PASSWORD_CONTROL_PERMISSION_LEVEL;
	...
	static {
		...
		PASSWORD_CONTROL_PERMISSION_LEVEL = BUILDER.comment("This controls the permission level required for people to be able to use /llamamod password set and reset, alongside the Password Changer Password Reset button")
