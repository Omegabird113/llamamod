package net.mcreator.llamamod.client.fluid;
...
public class AcidFluidExtension {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("llama_mod:block/acid");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("llama_mod:block/acid_flowing");
			private static final ResourceLocation RENDER_OVERLAY_TEXTURE = ResourceLocation.parse("llama_mod:textures/acid_fog.png");
