...
import net.mcreator.llamamod.world.inventory.DoubleSecureStoorafeBlockGuiMenu;
import net.mcreator.llamamod.procedures.IsAllowClearingBoxCheckedProcedure;
import net.mcreator.llamamod.network.DoubleSecureStoorafeBlockGuiButtonMessage;
...
public class DoubleSecureStoorafeBlockGuiScreen extends AbstractContainerScreen<DoubleSecureStoorafeBlockGuiMenu> implements LlamaModModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("llama_mod:textures/screens/double_secure_stoorafe_block_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.llama_mod.double_secure_stoorafe_block_gui.label_secure_stoorage_block"), 6, 6, -15658701, false);
	}

	@Override
	public void init() {
		super.init();
		button_clear = Button.builder(Component.translatable("gui.llama_mod.double_secure_stoorafe_block_gui.button_clear"), e -> {
		...
		button_close = Button.builder(Component.translatable("gui.llama_mod.double_secure_stoorafe_block_gui.button_close"), e -> {
			int x = DoubleSecureStoorafeBlockGuiScreen.this.x;
			int y = DoubleSecureStoorafeBlockGuiScreen.this.y;
			if (true) {
		...
		allow_clearing = Checkbox.builder(Component.translatable("gui.llama_mod.double_secure_stoorafe_block_gui.allow_clearing"), this.font).pos(this.leftPos + 175, this.topPos + 100).onValueChange((checkbox, value) -> {
