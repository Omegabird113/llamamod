package net.mcreator.llamamod.client.particle;
...
public class AcidparticleParticle extends TextureSheetParticle {
	...
	public static class AcidparticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public AcidparticleParticleProvider(SpriteSet spriteSet) {
