...
import net.mcreator.llamamod.procedures.CanBoneMealBeUsedOnBananaPlantProcedure;
import net.mcreator.llamamod.procedures.BannanaplantOnBoneMealSuccessProcedure;
...
public class BannanaplantBlock extends SugarCaneBlock implements BonemealableBlock, SimpleWaterloggedBlock {
	...
	public BannanaplantBlock(BlockBehaviour.Properties properties) {
		super(properties.mapColor(MapColor.COLOR_GREEN).randomTicks().sound(SoundType.GRASS).strength(0.12f, 0.55f).noOcclusion().dynamicShape().replaceable().ignitedByLava().offsetType(BlockBehaviour.OffsetType.XZ)
