package net.mcreator.llamamod.potion;
...
import net.mcreator.llamamod.procedures.AcideffectOnEffectActiveTickProcedure;
import net.mcreator.llamamod.procedures.AcideffectEffectStartedappliedProcedure;
