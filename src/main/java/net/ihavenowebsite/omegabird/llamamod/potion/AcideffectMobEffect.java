package net.ihavenowebsite.omegabird.llamamod.potion;
...
import net.ihavenowebsite.omegabird.llamamod.procedures.AcideffectOnEffectActiveTickProcedure;
import net.ihavenowebsite.omegabird.llamamod.procedures.AcideffectEffectStartedappliedProcedure;
