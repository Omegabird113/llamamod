...
public class AcidResistenceMobEffect extends MobEffect {
	public AcidResistenceMobEffect() {
		...
		this.addAttributeModifier(LlamamodModAttributes.ACID_DAMAGE_PROTECTION, ResourceLocation.fromNamespaceAndPath(LlamamodMod.MODID, "effect.acid_resistence_0"), 0.45, AttributeModifier.Operation.ADD_VALUE);
	}
}