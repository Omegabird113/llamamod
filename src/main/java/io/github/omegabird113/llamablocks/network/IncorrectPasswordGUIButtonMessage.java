...
public record IncorrectPasswordGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<IncorrectPasswordGUIButtonMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(LlamamodMod.MODID, "incorrect_password_gui_buttons"));
