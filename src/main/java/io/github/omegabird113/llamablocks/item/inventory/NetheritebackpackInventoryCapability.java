...
@EventBusSubscriber
public class NetheritebackpackInventoryCapability extends ItemAccessItemHandler {
	@SubscribeEvent
	...
	public boolean isValid(int index, ItemResource resource) {
		return super.isValid(index, resource) && resource.getItem() != LlamamodModItems.NETHERITE_BACKPACK.get();
	}
}