...
import io.github.omegabird113.llamablocks.network.SecurestooragepasswordguiButtonMessage;
...
public class SecurestooragepasswordguiScreen extends AbstractContainerScreen<SecurestooragepasswordguiMenu> implements LlamamodModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.llamamod.securestooragepasswordgui.label_secure_stoorage_block"), 5, 6, -16777216, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.llamamod.securestooragepasswordgui.label_enter_password"), 5, 17, -16777016, false);
	...
	public void init() {
		super.init();
		password = new EditBox(this.font, this.leftPos + 5, this.topPos + 27, 118, 18, Component.translatable("gui.llamamod.securestooragepasswordgui.password"));
