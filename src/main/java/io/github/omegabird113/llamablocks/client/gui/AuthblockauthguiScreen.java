...
import io.github.omegabird113.llamablocks.world.inventory.AuthblockauthguiMenu;
import io.github.omegabird113.llamablocks.procedures.IsThisBetaProcedureProcedure;
import io.github.omegabird113.llamablocks.network.AuthblockauthguiButtonMessage;
...
public class AuthblockauthguiScreen extends AbstractContainerScreen<AuthblockauthguiMenu> implements LlamamodModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("llamamod:textures/screens/my-levae_the_password_feild_empty_if_you_havent_yet_configured_a_password..png"), this.leftPos + -15, this.topPos + 76, 0, 0, 0, 0, 0, 0);
	...
	public void init() {
		...
		button_submit = Button.builder(Component.translatable("gui.llamamod.authblockauthgui.button_submit"), e -> {
			...
			if (true) {
				PacketDistributor.sendToServer(new AuthblockauthguiButtonMessage(0, x, y, z));
		...
		button_x = Button.builder(Component.translatable("gui.llamamod.authblockauthgui.button_x"), e -> {
			...
			int y = AuthblockauthguiScreen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new AuthblockauthguiButtonMessage(1, x, y, z));
