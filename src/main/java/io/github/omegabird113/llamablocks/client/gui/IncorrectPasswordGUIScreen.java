...
import io.github.omegabird113.llamablocks.network.IncorrectPasswordGUIButtonMessage;
...
public class IncorrectPasswordGUIScreen extends AbstractContainerScreen<IncorrectPasswordGUIMenu> implements LlamamodModScreens.ScreenAccessor {
	...
	private static final Identifier BACKGROUND = Identifier.parse("llamamod:textures/screens/incorrect_password_gui.png");
	...
	public void extractBackground(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, IMAGE_0, this.leftPos + 3, this.topPos + 4, 0, 0, 16, 16, 16, 16);
	}
	...
	protected void extractLabels(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY) {
		guiGraphics.text(this.font, Component.translatable("gui.llamamod.incorrect_password_gui.label_error"), 22, 10, -6946816, false);
		guiGraphics.text(this.font, Component.translatable("gui.llamamod.incorrect_password_gui.label_please_close_this_gui_and"), 5, 24, -12829636, false);
		guiGraphics.text(this.font, Component.translatable("gui.llamamod.incorrect_password_gui.label_retry_entering_the_password"), 5, 33, -12829636, false);
		if (IsThisBetaProcedureProcedure.execute())
			guiGraphics.text(this.font, Component.translatable("gui.llamamod.incorrect_password_gui.label_beta"), 1, -11, -65536, false);
	}
