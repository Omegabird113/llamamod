...
public class IncorrectPasswordGUIScreen extends AbstractContainerScreen<IncorrectPasswordGUIMenu> implements LlamamodModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = new ResourceLocation("llamamod:textures/screens/incorrect_password_gui.png");
	private static final ResourceLocation IMAGE_0 = new ResourceLocation("llamamod:textures/screens/error.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(IMAGE_0, this.leftPos + 3, this.topPos + 4, 0, 0, 16, 16, 16, 16);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.llamamod.incorrect_password_gui.label_error"), 22, 10, -6946816, false);
	...
	public void init() {
		...
		button_x = Button.builder(Component.translatable("gui.llamamod.incorrect_password_gui.button_x"), e -> {
			...
			if (true) {
				LlamamodMod.PACKET_HANDLER.sendToServer(new IncorrectPasswordGUIButtonMessage(0, x, y, z));
