...
import io.github.omegabird113.llamablocks.procedures.ReturnIfBlockDoesNotSupportsPasswordSystemProcedure;
...
public class PasswordchangerguiScreen extends AbstractContainerScreen<PasswordchangerguiMenu> implements LlamamodModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("llamamod:textures/screens/warning.png"), this.leftPos + 1, this.topPos + -16, 0, 0, 16, 16, 16, 16);
		if (ReturnIfBlockDoesNotSupportsPasswordSystemProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("llamamod:textures/screens/error.png"), this.leftPos + 1, this.topPos + -36, 0, 0, 16, 16, 16, 16);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		if (ReturnIfBlockDoesNotSupportsPasswordSystemProcedure.execute(world, x, y, z))
			guiGraphics.drawString(this.font, Component.translatable("gui.llamamod.passwordchangergui.label_a_password"), 16, -29, -42406, false);
	}
