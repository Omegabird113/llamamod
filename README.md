...
[![License](https://img.shields.io/badge/license-GPL%203.0-brightgreen.svg)](https://github.com/Omegabird113/llamamod/blob/master/LICENSE)
...
**Note that these links and the GitHub page are the ONLY official and safe places to download LlamaBlocks. I do not have official accounts on other websites. DO NOT DOWNLOAD IT FROM OTHER SOURCES. In fact, some non-trustworthy modding impersonate real mod creators to gain money or even distribute malware, so be careful!!**
