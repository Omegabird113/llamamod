...
- A saturation modifier of `1.25` *(it gives `5` saturation points)*
- It can be eaten in `11 ticks` *(You can eat them in `0.55 seconds` instead of the typical `1.6 seconds` for food)*
